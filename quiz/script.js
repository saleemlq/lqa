...
document.addEventListener("DOMContentLoaded", () => {
  // Load active student if saved
  const savedActive = localStorage.getItem("activeStudent");
  if (savedActive) {
    currentStudent = savedActive;
  }
...
function loadStudents() {
  ...
  selected.textContent = currentStudent || "-- Select Student --";
  ...
  list.forEach((name) => {
    ...
    // auto-highlight if it's the active student
    ...
    li.addEventListener("click", (e) => {
      ...
      selected.textContent = name;
      currentStudent = name;
      localStorage.setItem("activeStudent", name); // ✅ save active student
