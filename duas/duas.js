export const duas = [
  ...
  { id:'d6', name:'Dua When Sneezing', arabic:'ٱلْـحَمْدُ لِلَّهِ', translation:'All praise is for Allah.' },
  { id:'d7', name:'Response to Sneezer', arabic:'يَرْحَمُكَ اللَّهُ', translation:'May Allah have mercy on you.' },
  ...
  { id:'d11', name:'Before Entering Toilet', arabic:'اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْخُبْثِ وَالْخَبَائِثِ', translation:'O Allah, I seek refuge with You from male and female devils.' },
  { id:'d12', name:'After Leaving Toilet', arabic:'غُفْرَانَكَ', translation:'I ask You for forgiveness.' },
  ...
  { id:'d21', name:'Protection from Worry', arabic:'ٱللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْهَمِّ وَالْحَزَنِ', translation:'O Allah, I seek refuge in You from worry and sadness.' },
  { id:'d22', name:'Asking for Health', arabic:'ٱللَّهُمَّ عَافِنِي فِي بَدَنِي', translation:'O Allah, grant me health in my body.' },
  { id:'d23', name:'Asking for Light', arabic:'ٱللَّهُمَّ ٱجْعَلْ فِي قَلْبِي نُورًا', translation:'O Allah, place light in my heart.' },
  { id:'d24', name:'Praying for Jannah', arabic:'ٱللَّهُمَّ إِنِّي أَسْأَلُكَ ٱلْجَنَّةَ', translation:'O Allah, I ask You for Paradise.' },
  { id:'d25', name:'When Hearing the Adhan', arabic:'لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِٱللَّهِ', translation:'There is no power nor might except with Allah.' },
  { id:'d26', name:'When It Rains', arabic:'ٱللَّهُمَّ صَيِّبًا نَافِعًا', translation:'O Allah, a beneficial rain.' },
  { id:'d27', name:'After Rain', arabic:'مُطِرْنَا بِفَضْلِ ٱللَّهِ وَرَحْمَتِهِ', translation:'We have been given rain by Allah’s grace and mercy.' },
  { id:'d28', name:'Before Entering the Market', arabic:'لَا إِلٰهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ', translation:'There is no god but Allah, alone without partner.' },
  { id:'d29', name:'For Good Manners', arabic:'ٱللَّهُمَّ ٱهْدِنِي لِأَحْسَنِ ٱلْأَخْلَاقِ', translation:'O Allah, guide me to the best of manners.' },
  { id:'d30', name:'Blessing in the Morning', arabic:'ٱللَّهُمَّ إِنِّي أَسْأَلُكَ خَيْرَ هَذَا ٱلْيَوْمِ', translation:'O Allah, I ask You for the good of this day.' }
];
